...
class RegularColor{
  ...
  static const Color white = Color(0xffffffff); //<!--204-->
  ...
  static const Color green_1 = Color(0xff2ed184); //<!--204-->
  static const Color green_62 = Color(0xff626262); //<!--204-->
  static const Color green_e5 = Color(0xffe5e5e5); //<!--204-->
  static const Color blue_1 = Color(0xff00C2FD); //<!--204-->
  static const Color lable_clour= Color(0xffff0000); //<!--204-->
}